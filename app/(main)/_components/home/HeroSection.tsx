...
const HeroSection = () => {
    return (
        <div className="bg-teal-50 text-black flex h-screen items-center align-middle text-center w-full py-20 px-4 sm:px-6 lg:px-8">
            <div className='m-auto lg:flex lg:w-full'>
                ...
                <div className='hidden lg:flex lg:w-1/2 justify-center items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" width="949.85"
                        ...
                        <path
                            ...
                            fill="#dfdfdf" strokeWidth="0" />
                        <rect x="179.09" y="25.72" width="592.95" height="368.63" fill="#fff" strokeWidth="0" />
                        ...
                        <path
                            ...
                            fill="#36344e" strokeWidth="0" />
                        <rect x="820.09" y="388" width="13.79" height="19.56" fill="#f2a7aa" strokeWidth="0" />
                        <path
                        ...
                        <rect x="865.58" y="374.8" width="13.79" height="19.56"
                            transform="translate(-71.35 519.94) rotate(-31.95)" fill="#f2a7aa" strokeWidth="0" />
                        <path
                        ...
                        <polygon points="863.24 226.57 801.92 226.57 820.32 147.3 847.03 147.3 863.24 226.57"
                            fill="#00c0a3" strokeWidth="0" />
                        <path id="uuid-52db3307-ec3e-496d-a5d4-9d1f33ffc652-45-45-44-288"
                        ...
                        <path
                            ...
                            fill="#00c0a3" strokeWidth="0" />
                        <path id="uuid-2800d917-a06e-4fc6-b661-0f9df9cadefc-46-46-45-289"
