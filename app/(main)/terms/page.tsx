...
const Terms = () => {
  return (
    <Card className="p-6 my-20 flex items-center justify-center flex-col bg-background w-2/3 lg:w-1/3 mx-auto">
      <CardTitle className="text-4xl py-6 text-center">FlairNow user usage terms</CardTitle>
      <CardDescription className="text-lg text-center">By using our website you agree to our usage terms</CardDescription>
      <CardContent>
        <p>
