...
// 			<tr>
// 				<td>
// 					<table class="row row-1" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #4b5563; background-size: auto;">
// 						<tbody>
// 							<tr>
// 								<td>
...
// 														<tr>
// 															<td class="pad">
// 																<h1 style="margin: 0; color: #ffffff; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 40px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 48px;"><strong>FlairNow</strong></h1>
// 															</td>
// 														</tr>
// 													</table>
...
// 						</tbody>
// 					</table>
// 					<table class="row row-2" align="center" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #4b5563;">
// 						<tbody>
// 							<tr>
// 								<td>
...
// 																<div class="alignment" align="center" style="line-height:10px">
// 																	<div style="max-width: 540px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/4016/shelf.jpg" style="display: block; height: auto; border: 0; width: 100%;" width="540" alt="Verify account" title="Verify account"></div>
// 																</div>
// 															</td>
// 														</tr>
// 													</table>
...
// 																<h1 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 36px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 43.199999999999996px;"><strong>Welcome {{username}}</strong></h1>
// 															</td>
// 														</tr>
// 													</table>
...
// <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{url}}" style="height:52px;width:237px;v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#4b5563">
// <w:anchorlock/>
// <v:textbox inset="0px,0px,0px,0px">
// <center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px">
// <![endif]--><a href="{{url}}" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#4b5563;border-radius:4px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:10px;padding-bottom:10px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:60px;padding-right:60px;font-size:16px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word; line-height: 32px;">Activate account</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
// 															</td>
// 														</tr>
// 													</table>
...
// 														<tr>
// 															<td class="pad" style="padding-bottom:5px;padding-top:25px;text-align:center;width:100%;">
// 																<h2 style="margin: 0; color: #555555; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 24px; font-weight: normal; letter-spacing: normal; line-height: 120%; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 28.799999999999997px;"><strong>Lorem ipsum</strong></h2>
// 															</td>
// 														</tr>
// 													</table>
// 													<table class="paragraph_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
...
// 																<div style="color:#737487;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:18px;line-height:180%;text-align:center;mso-line-height-alt:32.4px;">
// 																	<p style="margin: 0;">&nbsp;</p>
// 																	<p style="margin: 0;">Lorem ipsum dolor sit amet accusamus vero minus, beatae tenetur suscipit provident maiores facere inventore quidem sit .</p>
// 																	<p style="margin: 0;">&nbsp;</p>
// 																</div>
// 															</td>
// 														</tr>
...
// 																<div class="alignment" align="center" style="line-height:10px">
// 																	<div style="max-width: 541px;"><img src="/emailverify.svg" style="display: block; height: auto; border: 0; width: 100%;" width="541"></div>
// 																</div>
// 															</td>
// 														</tr>
// 													</table>
